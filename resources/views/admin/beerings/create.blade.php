                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="title" name="title" placeholder="@lang($app_module->name.'.'.$app_action->name.'.form.title.placeholder')" type="text" value="{{ old('title') }}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control TMCE_basic" id="objective" name="objective" placeholder="@lang($app_module->name.'.'.$app_action->name.'.form.objective.placeholder')" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control TMCE_basic" id="description" name="description" placeholder="@lang($app_module->name.'.'.$app_action->name.'.form.description.placeholder')" rows="7"></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="amount" name="amount" placeholder="@lang($app_module->name.'.'.$app_action->name.'.form.amount.placeholder')" type="text" value="{{ old('amount') }}"/>
