                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm">{{ trans('forms.password_confirmation.field') }}</label>
                            <input class="form-control" id="password-confirm" name="password_confirmation" placeholder="{{ trans('forms.password_confirmation.placeholder') }}" type="password"/>
